package fr.maxlego08.convert.inventory;
...
import fr.maxlego08.convert.exceptions.InventoryOpenException;
import fr.maxlego08.convert.zcore.utils.ZUtils;
import fr.maxlego08.convert.zcore.utils.builder.ItemBuilder;
import fr.maxlego08.convert.zcore.utils.inventory.InventoryResult;
import fr.maxlego08.convert.zcore.utils.inventory.ItemButton;

public abstract class VInventory extends ZUtils implements Cloneable {

	protected int id;
	protected ConvertPlugin plugin;
	...
	protected InventoryResult preOpenInventory(ConvertPlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(ConvertPlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onClose(InventoryCloseEvent event, ConvertPlugin plugin, Player player) {
	}
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, ConvertPlugin plugin, Player player) {
	}
