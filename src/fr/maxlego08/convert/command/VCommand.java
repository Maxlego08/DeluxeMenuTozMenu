package fr.maxlego08.convert.command;
...
import fr.maxlego08.convert.zcore.utils.commands.Arguments;
import fr.maxlego08.convert.zcore.utils.commands.CollectionBiConsumer;
import fr.maxlego08.convert.zcore.utils.commands.CommandType;
import fr.maxlego08.convert.zcore.utils.commands.Tab;

public abstract class VCommand extends Arguments {

	protected final ConvertPlugin plugin;
	 ...
	 * @param plugin
	 */
	public VCommand(ConvertPlugin plugin) {
		super();
		this.plugin = plugin;
	}
	 ...
	 * @return
	 */
	public CommandType prePerform(ConvertPlugin plugin, CommandSender commandSender, String[] args) {
	 ...
	 */
	protected abstract CommandType perform(ConvertPlugin plugin);
	 ...
	 * @return
	 */
	public List<String> toTab(ConvertPlugin plugin, CommandSender sender, String[] args) {
